...
#EOF
    ...
    relu-renorm-layer name=tdnn1 input=Append(-2,1) dim=128
    ...
    output-layer name=output dim=$num_targets learning-rate-factor=$learning_rate_factor max-change=1.5
