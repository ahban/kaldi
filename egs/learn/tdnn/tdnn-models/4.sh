...
#EOF
    ...
    relu-renorm-layer name=tdnn3 input=Append(-2,1) dim=128
    relu-renorm-layer name=tdnn4 input=Append(-1,2) dim=256
    relu-renorm-layer name=tdnn2 input=Append(-3,2) dim=128

    ## adding the layers for chain branch
    relu-renorm-layer name=prefinal-chain input=tdnn2 dim=256 target-rms=0.5
    ...
    relu-renorm-layer name=prefinal-xent input=tdnn2 dim=256 target-rms=0.5
