...
EOF
    ...
    relu-renorm-layer name=tdnn1 input=Append(-2,1) dim=4
    relu-renorm-layer name=tdnn2 input=Append(-1,2) dim=5

    ## adding the layers for chain branch
    relu-renorm-layer name=prefinal-chain input=tdnn2 dim=6 target-rms=0.5
    ...
    relu-renorm-layer name=prefinal-xent input=tdnn2 dim=7 target-rms=0.5
