...
[ -z "$model" ] && { echo "you have to specify a model"; exit 1; }
[ -f "$model" ] || { echo "you have to specify a model which is exist"; exit 1; }

[ -z "$srcdir" ] && { echo "you have to specify srcdir that has configures "; exit 1; }
[ -d "$srcdir" ] || { echo "you have to specify srcdir that is exist"; exit 1; }
